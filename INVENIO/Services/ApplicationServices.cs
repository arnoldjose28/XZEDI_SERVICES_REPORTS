...
namespace INVENIO.Services
{
    ...
    public class ApplicationServicesBase
    {
        ...
        {
            INVENIO.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            ...
            if (css == null)
            	css = ConfigurationManager.ConnectionStrings["INVENIO"];
            ...
            if (Membership.GetUser("admin") == null)
            {
                ...
                admin = Membership.CreateUser("admin", "admin123%", "admin@INVENIO.com", "ASP.NET", "Code OnTime", true, out status);
                user = Membership.CreateUser("user", "user123%", "user@INVENIO.com", "ASP.NET", "Code OnTime", true, out status);
    ...
    public class ApplicationSessionStateBase : SessionStateStoreProviderBase
    {
        ...
        public SqlText CreateSqlText(string sql)
        {
            ...
            cmd.Name = "INVENIO Session State Provider";
