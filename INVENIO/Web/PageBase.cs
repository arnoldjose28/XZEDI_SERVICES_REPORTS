...
namespace INVENIO.Web
{
    ...
    public class PageBaseCore : System.Web.UI.Page
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            tempWriter.Flush();
            tempWriter.Close();
            string page = INVENIO.Data.Localizer.Replace("Pages", Path.GetFileName(Request.PhysicalPath), sb.ToString());
    ...
    public class ControlBaseCore : System.Web.UI.UserControl
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            tempWriter.Flush();
            tempWriter.Close();
            writer.Write(INVENIO.Data.Localizer.Replace("Pages", Path.GetFileName(Request.PhysicalPath), sb.ToString()));
        }
        ...
        public static System.Web.UI.Control LoadPageControl(System.Web.UI.Control placeholder, string pageName, bool developmentMode)
        {
            try
            {
                ...
                string basePath = "~";
                if (!(developmentMode))
                	basePath = "~/DesktopModules/INVENIO";
