    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                Stream res = GetType().Assembly.GetManifestResourceStream(String.Format("INVENIO.Controllers.{0}.xml", DataController));
                if (res == null)
                	res = GetType().Assembly.GetManifestResourceStream(String.Format("INVENIO.{0}.xml", DataController));
                if (res != null)
