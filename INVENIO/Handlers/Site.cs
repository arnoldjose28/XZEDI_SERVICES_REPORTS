...
namespace INVENIO.Handlers
{
	public partial class Site : SiteBase
    {
    }
    
    public class SiteBase : INVENIO.Web.PageBase
    {
        ...
        public static string Copyright
        {
            get
            {
                return "© INVENIO INTELECTUAL S.A 2019";
            }
        }
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            string themePath = Server.MapPath("~/App_Themes/INVENIO");
            if (Directory.Exists(themePath))
            	foreach (string stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!(fileName.Equals("_Theme_DarkKnight.css")))
                    {
                        ...
                        link.Href = ("~/App_Themes/INVENIO/" + fileName);
