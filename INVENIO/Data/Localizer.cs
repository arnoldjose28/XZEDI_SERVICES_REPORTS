...
namespace INVENIO.Data
{
    ...
    public class Localizer
    {
        ...
        public static Stream CreateDictionaryStream(string culture, string baseName, string objectName, out string[] files)
        {
            ...
            Stream result = t.Assembly.GetManifestResourceStream(CultureManager.ResolveEmbeddedResourceName(String.Format("INVENIO.{0}{1}", baseName, fileName), culture));
            if (result == null)
            	result = t.Assembly.GetManifestResourceStream(CultureManager.ResolveEmbeddedResourceName(String.Format("INVENIO.{0}", fileName), culture));
            if (result == null)
            {
        ...
        public static LocalizationDictionary CreateDictionary(string baseName, string objectName)
        {
            ...
            string fileName = String.Format("INVENIO.{0}.{1}.txt", objectName, culture);
