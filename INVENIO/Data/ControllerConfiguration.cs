...
namespace INVENIO.Data
{
	public class ControllerConfiguration
    {
        ...
        protected virtual void Initialize(XPathNavigator navigator)
        {
            ...
            {
                Type t = Type.GetType("INVENIO.Rules.SharedBusinessRules");
                if (t != null)
...
<action id=""a5"" commandName=""Edit"" causesValidation=""true"" />
        ...
        public string LoadLayout(string view)
        {
            ...
            while (tryLoad)
            {
                ...
                {
                    Stream stream = GetType().Assembly.GetManifestResourceStream(String.Format("INVENIO.Views.{0}.{1}.html", this.ControllerName, view));
                    if (stream != null)
