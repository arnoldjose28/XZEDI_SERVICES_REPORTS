    ...
    public partial class DataControllerBase : IDataController, IAutoCompleteManager, IDataEngine, IBusinessObject
    {
        ...
        public virtual string GetSurvey(string surveyName)
        {
            ...
            if (String.IsNullOrEmpty(survey))
            	survey = ControllerConfigurationUtility.GetResourceText(String.Format("INVENIO.Surveys.{0}.min.js", surveyName), String.Format("INVENIO.{0}.min.js", surveyName), String.Format("INVENIO.Surveys.{0}.js", surveyName), String.Format("INVENIO.{0}.js", surveyName));
            if (String.IsNullOrEmpty(survey))
            	throw new HttpException(404, "Not found.");
            if (String.IsNullOrEmpty(layout))
            	layout = ControllerConfigurationUtility.GetResourceText(String.Format("INVENIO.Surveys.{0}.html", surveyName), String.Format("INVENIO.Surveys.{0}.htm", surveyName), String.Format("INVENIO.{0}.html", surveyName), String.Format("INVENIO.{0}.htm", surveyName));
            if (String.IsNullOrEmpty(rules))
            	rules = ControllerConfigurationUtility.GetResourceText(String.Format("INVENIO.Surveys.{0}.rules.min.js", surveyName), String.Format("INVENIO.{0}.rules.min.js", surveyName), String.Format("INVENIO.Surveys.{0}.rules.js", surveyName), String.Format("INVENIO.{0}.rules.js", surveyName));
