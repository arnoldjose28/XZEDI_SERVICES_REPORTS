...
namespace INVENIO.Data
{
	public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                	res = ControllerConfigurationUtility.GetResourceStream(String.Format("INVENIO.controllers.{0}.xml", controller), String.Format("INVENIO.{0}.xml", controller));
                if (res == null)
                {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            if (t == null)
            	t = typeof(INVENIO.Data.Controller);
            Stream res = ControllerConfigurationUtility.GetResourceStream(String.Format("INVENIO.Reports.{0}", name), String.Format("INVENIO.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                ControllerConfiguration config = INVENIO.Data.Controller.CreateConfigurationInstance(t, controller);
